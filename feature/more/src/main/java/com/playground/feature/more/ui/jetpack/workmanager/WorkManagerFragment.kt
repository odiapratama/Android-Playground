package com.playground.feature.more.ui.jetpack.workmanager
...
import com.playground.core.network.FileDownloadWorker
import com.playground.core.ui.ext.lazyViewBinding
import com.playground.core.ui.ext.toGone
import com.playground.core.ui.ext.toVisible
import com.playground.feature.more.R
import com.playground.feature.more.databinding.WorkManagerFragmentBinding

class WorkManagerFragment : Fragment(R.layout.work_manager_fragment) {

    private val binding by lazyViewBinding(WorkManagerFragmentBinding::bind)
    ...
    private fun initView() {
        ...
        val fileDownload = com.playground.feature.more.data.model.FileDownload(
            id = "192401",
    ...
    private fun startDownloadFile(
        file: com.playground.feature.more.data.model.FileDownload,
        success: (String) -> Unit,
        failed: (String) -> Unit,
        running: () -> Unit
    ) {
